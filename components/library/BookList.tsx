        ...
        return (
          <button
            ...
            className={`w-full flex items-center gap-4 p-4 rounded-2xl border transition-all ${
              activeBookId === book.id
                ? "bg-surface-2 ring-2 ring-[color:var(--tvx-accent)]"
                : "bg-card border-card"
          ...
          >
            ...
            <div className="flex-1 min-w-0 text-left">
              <div className={`font-black text-sm line-clamp-1 heading-font ${textPrimary}`}>
                {book.title}
              </div>
              <div className={`text-[10px] font-bold uppercase tracking-tighter ${textMuted}`}>
